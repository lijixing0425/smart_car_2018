...
int kp[7][7]= {   
                  {steer_kp_PB,steer_kp_PB,steer_kp_PB,steer_kp_PM,steer_kp_PM,steer_kp_PS,steer_kp_PS}, 
                  {steer_kp_PB,steer_kp_PB,steer_kp_PM,steer_kp_PM,steer_kp_PS,steer_kp_PS,steer_kp_ZO}, 
                  {steer_kp_PB,steer_kp_PM,steer_kp_PM,steer_kp_PS,steer_kp_PS,steer_kp_ZO,steer_kp_ZO},  
                  {steer_kp_PB,steer_kp_PM,steer_kp_PS,steer_kp_PS,steer_kp_NS,steer_kp_NM,steer_kp_NB},                 
                  {steer_kp_ZO,steer_kp_ZO,steer_kp_NS,steer_kp_NS,steer_kp_NM,steer_kp_NM,steer_kp_NB}, 
                  {steer_kp_ZO,steer_kp_NS,steer_kp_NS,steer_kp_NM,steer_kp_NM,steer_kp_NB,steer_kp_NB}, 
...
int speed[7][7]={  
                    {motor_speed_PB,motor_speed_PB,motor_speed_PB,motor_speed_PB,motor_speed_PM,motor_speed_PS,motor_speed_ZO},
                    {motor_speed_PB,motor_speed_PB,motor_speed_PB,motor_speed_PM,motor_speed_PS,motor_speed_PS,motor_speed_ZO}, 
                    {motor_speed_PB,motor_speed_PM,motor_speed_PM,motor_speed_PS,motor_speed_PS,motor_speed_ZO,motor_speed_ZO},               
                    {motor_speed_PB,motor_speed_PM,motor_speed_PS,motor_speed_ZO,motor_speed_NS,motor_speed_NM,motor_speed_NB},                 
                    {motor_speed_ZO,motor_speed_ZO,motor_speed_NS,motor_speed_NS,motor_speed_NM,motor_speed_NM,motor_speed_NB},
                    {motor_speed_ZO,motor_speed_NS,motor_speed_NS,motor_speed_NM,motor_speed_NB,motor_speed_NB,motor_speed_NB},   
                    {motor_speed_ZO,motor_speed_NS,motor_speed_NM,motor_speed_NB,motor_speed_NB,motor_speed_NB,motor_speed_NB} 
               };
...
int  FUZZ_SPEED_GET(int a,int b)
{
    float es[7],ecs[7];
    float form[7][7];
    float P1;
