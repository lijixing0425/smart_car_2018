...
int is_round_pluse;
int podao_pluse;
int round_pluse;             // 打角 -- 出环
int round_pluse1;            // 识别 -- 打角
int out_round_pluse;         // 直走开始计的脉冲
int straight_pluse;         //  根据环内脉冲算出的合理直走脉冲
int str_Yes_pluse;          //  出环后经过一定脉冲 成立直走
...
Site_t angle_line[82];
Site_t angle_line2[82];
Site_t angle_line3[82];
/*****************nrf****************************/
uint8 buff[32];
int NRF_B;
