...
extern int str_Yes_pluse;          //  出环后经过一定脉冲 成立直走
...
/*****************电机变量*************************/
extern int Actual_L_pluse;    //实际左轮脉冲
extern int Actual_R_pluse;    //实际右轮脉冲
...
extern int fuzzy_error[6];      //  记录前几次偏差
extern int fuzzy_time;
extern int steer_ec;        //  偏差变化率
